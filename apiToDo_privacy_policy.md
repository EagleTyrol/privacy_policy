...
## Für die App: ApiToDo
Der Schutz Ihrer Daten ist uns ein besonderes Anliegen. Wir verarbeiten Ihre Daten ausschließlich auf Grundlage der gesetzlichen Bestimmungen (DSGVO, TKG 2021). In diesen Datenschutzinformationen informieren wir Sie über die wichtigsten Aspekte der Datenverarbeitung im Rahmen unserer App.

---

### 1. Name und Kontaktdaten des Verantwortlichen (Art. 13 Abs. 1 lit. a)
**EagleTyrol - Bernhard Fischler** A-6095 Anger 9, Österreich  
**E-Mail:** [eagle.tirol@gmail.com](mailto:eagle.tirol@gmail.com)

---

### 2. Art der gespeicherten Daten & Lokale Speicherung
**Lokale Verschlüsselung (SQLCipher):** Ein wesentlicher Teil Ihrer imkerlichen Daten (z. B. Stockkarten, Behandlungsdaten, Notizen) wird primär lokal in einer verschlüsselten Datenbank auf Ihrem Endgerät gespeichert. Diese Daten verlassen Ihr Endgerät nur, wenn Sie explizit Funktionen wie die Cloud-Sicherung (Firebase) oder den PDF-Export nutzen.

---

### 3. Verarbeitungszwecke und Rechtsgrundlagen
Wir verarbeiten Daten nach den Grundsätzen der Rechtmäßigkeit, Zweckbindung, Datenminimierung und Richtigkeit (**Art. 5 DSGVO**). Die Verarbeitung erfolgt auf Basis folgender Rechtsgrundlagen:
* **Vertragserfüllung (Art. 6 Abs. 1 lit. b DSGVO):** Um Ihnen die Funktionen der App (Bestandsführung, Synchronisation, Protokollierung) zur Verfügung zu stellen.
* **Berechtigtes Interesse (Art. 6 Abs. 1 lit. f DSGVO):** Soweit technische Log-Daten oder Analysen erfasst werden, geschieht dies zur Gewährleistung der Stabilität und Verbesserung der App.
...
> **Besonderheit: Selbstständige Datenlöschung (Firebase)** > In der App ApiToDo haben Sie jederzeit die Möglichkeit, Ihr Konto und die damit verknüpften Daten bei Firebase selbstständig zu löschen. Über die Funktion „Konto löschen“ in den Einstellungen werden Ihre in der Cloud gespeicherten personenbezogenen Daten (Authentication & Cloud-Datenbanken) unverzüglich und unwiderruflich entfernt.

---

### 6. Besonderheiten bei Kindern
In Österreich liegt die Altersgrenze für die Einwilligung bei Diensten der Informationsgesellschaft gemäß den nationalen Bestimmungen beim vollendeten **14. Lebensjahr**.

---

### 7. Speicherdauer
Personenbezogene Daten werden nur so lange gespeichert, wie es für die Zwecke (App-Nutzung, gesetzliche Aufbewahrungsfristen) erforderlich ist. Lokale Daten werden bei Deinstallation der App von Ihrem Gerät entfernt, sofern Sie keine externe Sicherung erstellt haben.

---

### 8. Recht auf Beschwerde
Haben Sie den Verdacht auf Verstöße gegen das Datenschutzrecht, können Sie sich bei der Aufsichtsbehörde beschweren. In Österreich ist dies die:
